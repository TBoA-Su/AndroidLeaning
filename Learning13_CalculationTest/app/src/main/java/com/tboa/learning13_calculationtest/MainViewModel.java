...
public class MainViewModel extends AndroidViewModel {
    ...
    private static String KEY_ON_ANSWERING = "key_on_answering";
    ...
    public MainViewModel(@NonNull Application application, SavedStateHandle handle) {
        ...
        if (!handle.contains(KEY_HIGH_SCORE)) {
            ...
            handle.set(KEY_ON_ANSWERING, false);
        }
        this.handle = handle;
    }
    ...
    public MutableLiveData<Boolean> getOnAnswering() {
        return handle.getLiveData(KEY_ON_ANSWERING);
    }
